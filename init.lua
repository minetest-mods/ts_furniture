function register_furniture(mod, name, description, texture)
...
register_furniture("default", "aspen_wood" , "Aspen"      , "default_aspen_wood.png" )
register_furniture("default", "pine_wood"  , "Pine"       , "default_pine_wood.png"  )
register_furniture("default", "acacia_wood", "Acacia"     , "default_acacia_wood.png")
register_furniture("default", "wood"       , "Wooden"     , "default_wood.png"       )
register_furniture("default", "junglewood" , "Jungle Wood", "default_junglewood.png" )
